...
# Check if required libraries will be needed
print("\nRequired libraries for this demo:")
print("  - pandas (built-in)")
print("  - numpy (built-in)")
print("  - matplotlib (built-in)")
print("  - seaborn (built-in)")
print("  - pyyaml (install if needed)")
...
from pyspark.sql.functions import rand, col  # Re-import col to fix shadowing
